    ...
    return (
        <div className={isMenuOpen ? openMenu : closeMenu}>
            ...
            <div className='flex flex-row justify-center mt-auto mb-28 gap-2'>
                <a className="text-white font-bold text-md" href='https://syazanie.com' target='_blank'>Created by <span className='text-blue-200'>Syazanie Amirin | V1.3.8.3</span></a>
