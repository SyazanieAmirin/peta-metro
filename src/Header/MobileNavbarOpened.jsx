    ...
    return (
        <div className={isMenuOpen ? openMenu : closeMenu}>
            ...
            <div className='flex flex-row justify-center mt-auto mb-16 gap-2'>
                <a className="text-white font-bold text-md" href='https://syazanieamirin.github.io/portfolio.github.io/' target='_blank'>Created by <span className='text-blue-200'>Syazanie Amirin | V1.0.9</span></a>
