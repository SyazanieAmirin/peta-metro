export default function Footer() {
    return (
        <footer className="bg-secondary flex flex-row items-center justify-center py-2 w-full mt-10 align-middle gap-2 flex-wrap animate-fade-in">
            <a className="text-white font-bold text-md" href='https://syazanie.com' target='_blank'>Created by <span className='text-blue-200'>Syazanie Amirin | V1.3.7.2</span></a>
